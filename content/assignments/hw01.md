...
1. **Behavior:** Step-by-step what happens (validation, database queries, business logic)
1. **Output:** What the endpoint returns (status code, response body)
1. **Errors:** What errors can occur and when
